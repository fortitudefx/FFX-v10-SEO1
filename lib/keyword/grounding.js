...
export function keywordArticleInstruction(target, hasNuggets = true) {
  ...
  const base = '\n\nSOURCE MODE: KEYWORD (demand-driven).\n'
    ...
    + 'expected, or promised outcome. HARD BAN: do not attach any number to the reader — never '
    + 'write "you ride it for [N]R", "you get [N]R", "this gives you", "expect [N]R", or similar. '
    + 'An R-multiple or return may appear ONLY as a specific PAST instance attributed to Salman '
    + 'in past tense (e.g. "Salman has taken a trade that ran to 40R"). Any other use of a number '
    + 'as a result fails the quality gate on a YMYL page — when in doubt, omit the number.\n'
