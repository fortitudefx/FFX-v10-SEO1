...
// Warn-only (gate.js:167 records a warning and still returns 'passed'), so this
// governs NOISE, not what ships. Lowered 70 -> 65 on 2026-07-28: real output sits
// around 70, so a 70 threshold warned on almost everything and a warning that
// always fires is one nobody reads. 65 flags genuine drift instead.
// The AIM is still 70+ — that is a writing target, not a gate.
export const VOICE_THRESHOLD = 65;
